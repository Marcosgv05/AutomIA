        ...
        <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full max-w-md mx-auto lg:mx-0 animate-fade-in delay-200">
            ...
            <div className="lg:hidden text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-200 to-slate-500">Átimo</h1>
              ...
              <div className="relative bg-slate-900/80 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div className="relative group">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-11 pr-4 py-3 bg-slate-950/50 border border-slate-700/50 rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary/50 focus:bg-slate-950 outline-none transition-all text-slate-200 placeholder:text-slate-500"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          minLength={6}
                          className="w-full pl-11 pr-12 py-3 bg-slate-950/50 border border-slate-700/50 rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary/50 focus:bg-slate-950 outline-none transition-all text-slate-200 placeholder:text-slate-500"
                        />
                        <button
                          type="button"
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-slate-900/70 hover:bg-slate-800/80 text-slate-100 font-semibold rounded-lg transition-all duration-300 flex items-center justify-center gap-3 disabled:opacity-50 border border-slate-700/50 backdrop-blur-md shadow-lg shadow-primary/10 hover:shadow-primary/30 hover:scale-[1.02]"
                  >
                    {googleLoading ? (
                      <>
            ...
            <p className="text-center text-slate-500 text-xs mt-8 animate-fade-in delay-500">
              © 2024 Átimo. Automação inteligente para seu negócio.
            </p>
          </div>
        </div>
      </div>
